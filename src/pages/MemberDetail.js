    ...
    return (
        <div className='content'>
                  <div className="card_section margin_top_24">
                     <button onClick={(e) => props.showPage(e, 'sms:' + props.member.cell_phone1+ props.member.cell_phone2+ props.member.cell_phone3)}><img src={require('../assets/images/icon-24-message.png')}/></button>
                     <button onClick={(e) => props.showPage(e, 'tel:' + + props.member.cell_phone1+ props.member.cell_phone2+ props.member.cell_phone3)}><img src={require("../assets/images/icon-24-call.png")}/></button>
                  ...
                  <div className='card_section'>
                     <button onClick={(e) => props.showPage(e, 'mailto:' + props.member.work_email + '@paymint.co.kr')}><img src={require('../assets/images/icon-24-mail.png')}/></button>
                  ...
                  <div className="card_section small">
                     <button onClick={(e) => props.showPage(e, 'http://www.paymint.co.kr/hp/index.html')}><img src={require('../assets/images/icon-24-web.png')}/></button>
